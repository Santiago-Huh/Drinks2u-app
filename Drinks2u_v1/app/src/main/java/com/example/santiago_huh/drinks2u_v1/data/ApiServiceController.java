package com.example.santiago_huh.drinks2u_v1.data;
...
public class ApiServiceController {
    private String URL = "http://192.168.88.117:8000/";
    private String GetProductos = "pro/Drinks2u/";
    ...
    public void getProductos( Context con, final ApiWebListener listener)
    {
        RequestQueue queue = Volley.newRequestQueue(con);
        ApiService stringRequest = new ApiService(Request.Method.GET, URL+GetProductos,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        listener.onSuccess(response);
